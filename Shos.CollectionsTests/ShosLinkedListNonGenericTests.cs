...
namespace Shos.Collections.Tests
{
    ...
    [TestClass()]
    public class ShosLinkedListNonGenericTests
    {
        ShosLinkedList? linkedList = null;

        [TestInitialize]
        public void Setup() => linkedList = new ShosLinkedList();
        ...
        {
            linkedList = new ShosLinkedList(new int[] { });
            Assert.AreEqual(0, linkedList.Count);

            linkedList = new ShosLinkedList(new[] { 10, 30, 70 });
        ...
        {
            linkedList = new ShosLinkedList { 10, 60, 30 };
        ...
        {
            linkedList = new ShosLinkedList { 10 };
        ...
        {
            linkedList = new ShosLinkedList { 10, 70, 30 };
            linkedList.Clear();
            Assert.AreEqual(0, linkedList.Count);
            Assert.IsNull(linkedList.First);
            Assert.IsNull(linkedList.Last);
        ...
        {
            linkedList = new ShosLinkedList { 10, 70, 30, 40, 60, 90, 100 };
        ...
        {
            linkedList = new ShosLinkedList { 60, 30, 20 };
            linkedList.RemoveFirst();
        ...
        {
            linkedList = new ShosLinkedList { 20, 40, 80 };
            linkedList.RemoveLast();
        ...
        public void FindLastできる()
        {
            ...
            linkedList = new ShosLinkedList { 40, 30, 60, 30, 40, 20, 40 };
        ...
        public void Containsできる()
        {
            ...
            linkedList = new ShosLinkedList { 30, 60 };
        ...
        {
            linkedList = new ShosLinkedList { 10, 30 };
            linkedList.CopyTo(new object[2], 1);
        }
